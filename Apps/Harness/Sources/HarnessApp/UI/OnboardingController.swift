    ...
    static var all: [OnboardingPage] {
        ...
        pages.append(contentsOf: [
            ...
            OnboardingPage(
                ...
                title: "Sessions, tabs, and panes",
                subtitle: "Harness nests your work. A session is a sidebar row, it holds tabs, and each tab holds the pane layout.",
                bullets: [
