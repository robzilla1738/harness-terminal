...
**PR-25 · Event-driven git metadata + GUI snapshot-push subscription** · performance+architecture · M–L · ✅ **Shipped (#141)**
...
**PR-26 · Idle-efficiency bundle (app + daemon)** · performance · M · ✅ **Shipped (#142)**
...
**PR-27 · Search-highlight per-row interval index** · performance · S–M · ✅ **Shipped (#143)**
...
**PR-28 · `Scripts/scorecard.sh` — Harness vs Ghostty comparative scorecard** · tooling+proof · M · ✅ **Shipped (#146)**
...
**PR-29 · VT polish + safety hardening cluster** · ghostty-parity+safety · M–L *(absorbs AUDIT_ROADMAP PR-23, + SGR-pixel 1016)* · ✅ **Shipped (#144 engine + #145 kit/renderer)**
...
**PR-31 · Mechanical decomposition II — Daemon + Core** · tech-debt · M–L *(AUDIT_ROADMAP PR-22b)* · ✅ **Shipped (#147)**
...
**PR-33 · Test de-flake + tracked-doc truth pass** · hygiene · M · ✅ **Shipped (#148)**
...
**PR-34 · Parity long-tail quick wins** · ghostty-parity · M · ✅ **Shipped (#150)**
...
**PR-35 · Shell-integration auto-inject at spawn** · ux · M · **behavioral risk — ships last in Phase D** · ✅ **Shipped (#151)**
...
**PR-36 · Security posture review** · security · S–M *(absorbs AUDIT_ROADMAP PR-24)* · ✅ **Shipped (#149)**
...
**PR-37 · Measured micro-pass (strictly bench-gated)** · performance · S–M · **last code PR** · ✅ **Shipped (#154)**
